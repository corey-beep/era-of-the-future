    ...
    >
      ...
      <nav className="floating-nav">
        <a
          ...
          title="Discord"
        >
          <svg className="nav-icon" viewBox="0 0 71 55" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      {showTourMessage && (
        <div className="tour-message-overlay">
          <div className="tour-message-popup">
